    ...
    <form @submit.prevent>
      ...
      <div class="flex flex-row p-2 bg-white mb-2 shadow rounded-lg justify-between space-x-3 m-2">
        ...
        <div class="flex flex-row justify-between w-1/3">
          ...
          <div @click="saveRecipe()" class="flex h-10 w-10 rounded-full border border-gray-200 text-rose-500 bg-white-200 justify-center items-center hover:bg-rose-500 hover:text-white shadow cursor-pointer">
      ...
      <div class="flex flex-row justify-end mx-2 mb-2 shadow rounded-lg">
