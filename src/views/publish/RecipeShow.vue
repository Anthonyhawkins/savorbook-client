    ...
    <div class="mx-auto lg:w-4/5 max-w-screen-lg text-gray-600 my-3">
      ...
      <div class="flex flex-col bg-gray-50 lg:flex-row h-full pt-4 shadow rounded-lg">
              ...
              <div class="mb-4">
                <template v-for="dependentRecipe in recipe.dependentRecipes" :key="dependentRecipe.id">
                  <router-link :to="{ name: 'RecipeShow', params: { id: dependentRecipe.id }}">
                    ...
                    <div @click="navigate" class="flex flex-col text-sm rounded-md shadow-sm bg-rose-500 text-white hover:bg-rose-600 font-serif px-3 py-1 mb-1 ml-12 justify-between">
          ...
          <div class="flex flex-col lg:w-4/6 px-10 lg:pr-10 pb-4">
            ...
            <h1 class="text-rose-500 uppercase font-medium text-2xl mb-2">{{recipe.name}}</h1>
