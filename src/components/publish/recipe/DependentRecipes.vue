  ...
  <div class="flex flex-col">
    <div class="flex mb-3">
      <p class="text-sm text-gray-400">
        Great for more complex recipes. A good exmaple is if this was a Lasagna
        Recipe, Dependent Recipes would be a Bolognese Sauce, Fresh Pasta, and
        Bachemal Sauce.
      </p>
    </div>
    ...
    >
      <div class="flex">
        ...
        <span v-if="dependentRecipe.qty > 1" class="text-rose-100 mx-2"
          >batches of</span
        >
    ...
    <div class="relative">
      <div class="flex mt-2 space-x-1">
        ...
        <input
          v-model="recipeQty"
          class="w-3/12 text-gray-500 h-8 border-b border-gray-200 focus:outline-none focus:ring px-2 text-center"
          type="text"
      ...
      <div
        ...
        class="flex flex-row w-8/12 bg-red-200 rounded-b-md shadow-lg absolute top-10 overflow-auto h-auto max-h-32"
      >
